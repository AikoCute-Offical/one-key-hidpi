...
cat <<EEF
 ...
 |_|  |_| |_____| |_____/  |_|      |_____|
    ...
    By: AikoCute  Telegram : https://t.me/AikoCute                         
============================================
EEF
...
if [[ "${systemLanguage}" == "vi-VN" ]]; then
    langDisplay="Hiển thị"
    langMonitors="Màn hình"
    langIndex="Mục lục"
    langVendorID="Nhà cung cấp ID"
    langProductID="ID sản phẩm"
    langMonitorName="Tên hiển thị"
    langChooseDis="Chọn màn hình"
    langInputChoice="Nhập sự lựa chọn của bạn"
    langEnterError="Lỗi đánh máy, tạm biệt!"
    langBackingUp="Đang sao lưu (xem hướng dẫn để biết cách khôi phục) ..."
    langEnabled="Mở thành công, khởi động lại để có hiệu lực"
    langDisabled="Đóng thành công, khởi động lại để có hiệu lực"
    langEnabledLog="Logo sẽ rất lớn trong lần khởi động lại đầu tiên, nhưng không phải sau đó"
    langCustomRes="Nhập độ phân giải HIDPI mong muốn, được phân tách bằng dấu cách, như sau: 1680x945 1600x900 1440x810"

    langChooseIcon="Chọn biểu tượng hiển thị"
    langNotChange="giữ nó như nó là"

    langEnableHIDPI="(%d) Bật HIDPI"
    langEnableHIDPIEDID="(%d) Bật HIDPI (tiêm EDID cùng lúc)"
    langDisableHIDPI="(%d) Tắt HIDPI"

    langDisableOpt1="(1) Tắt HIDPI trên màn hình này"
    langDisableOpt2="(2) Khôi phục tất cả cài đặt về mặc định macOS"

    langChooseRes="Chọn cấu hình độ phân giải"
    langChooseResOp1="(1) 1920x1080 pixels"
    langChooseResOp2="(2) 1920x1080 pixels (Sử dụng độ phân giải 1424x802, khắc phục sự cố thu nhỏ màn hình sau khi ngủ dậy)"
    langChooseResOp3="(3) 1920x1200 pixels"
    langChooseResOp4="(4) 2560x1440 pixels"
    langChooseResOp5="(5) 3000x2000 pixels"
    langChooseResOpCustom="(6) Nhập độ phân giải theo cách thủ công"

    langNoMonitFound="Không tìm thấy màn hình. từ bỏ..."
    langMonitVIDPID="ID nhà cung cấp màn hình của bạn: ID sản phẩm:"
    ...
    langChooseResOp1="(1) 1920x1080 pixels"
    langChooseResOp2="(2) 1920x1080 pixels (使用 1424x802 分辨率，修复睡眠唤醒后的屏幕缩小问题)"
    langChooseResOp3="(3) 1920x1200 pixels"
    langChooseResOp4="(4) 2560x1440 pixels"
    langChooseResOp5="(5) 3000x2000 pixels"
...
function init() {
    ...
    downloadHost="https://raw.githubusercontent.com/AikoCute-Offical/one-key-hidpi/master"
